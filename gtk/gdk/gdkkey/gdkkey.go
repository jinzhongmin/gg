...
const (
	...
	KEY_masculine                   = 0x0ba
	KEY_ordmasculine                = 0x0ba
	KEY_guillemotright              = 0x0bb
	KEY_guillemetright              = 0x0bb
	...
	KEY_BrightnessAuto              = 0x100810f4
	KEY_DisplayOff                  = 0x100810f5
	KEY_Info                        = 0x10081166
	KEY_AspectRatio                 = 0x10081177
	KEY_DVD                         = 0x10081185
	KEY_Audio                       = 0x10081188
	KEY_ChannelUp                   = 0x10081192
	KEY_ChannelDown                 = 0x10081193
	KEY_VideoPhone                  = 0x100811a0
	KEY_ZoomReset                   = 0x100811a4
	KEY_Editor                      = 0x100811a6
	KEY_GraphicsEditor              = 0x100811a8
	KEY_Presentation                = 0x100811a9
	KEY_Database                    = 0x100811aa
	KEY_Voicemail                   = 0x100811ac
	KEY_Addressbook                 = 0x100811ad
	KEY_DisplayToggle               = 0x100811af
	KEY_SpellCheck                  = 0x100811b0
	KEY_ContextMenu                 = 0x100811b6
	KEY_MediaRepeat                 = 0x100811b7
	KEY_10ChannelsUp                = 0x100811b8
	KEY_10ChannelsDown              = 0x100811b9
	KEY_Images                      = 0x100811ba
	KEY_NotificationCenter          = 0x100811bc
	KEY_PickupPhone                 = 0x100811bd
	KEY_HangupPhone                 = 0x100811be
	KEY_Fn                          = 0x100811d0
	KEY_Fn_Esc                      = 0x100811d1
	KEY_FnRightShift                = 0x100811e5
	KEY_Numeric0                    = 0x10081200
	KEY_Numeric1                    = 0x10081201
	KEY_Numeric2                    = 0x10081202
	KEY_Numeric3                    = 0x10081203
	KEY_Numeric4                    = 0x10081204
	KEY_Numeric5                    = 0x10081205
	KEY_Numeric6                    = 0x10081206
	KEY_Numeric7                    = 0x10081207
	KEY_Numeric8                    = 0x10081208
	KEY_Numeric9                    = 0x10081209
	KEY_NumericStar                 = 0x1008120a
	KEY_NumericPound                = 0x1008120b
	KEY_NumericA                    = 0x1008120c
	KEY_NumericB                    = 0x1008120d
	KEY_NumericC                    = 0x1008120e
	KEY_NumericD                    = 0x1008120f
	KEY_CameraFocus                 = 0x10081210
	KEY_WPSButton                   = 0x10081211
	KEY_CameraZoomIn                = 0x10081215
	KEY_CameraZoomOut               = 0x10081216
	KEY_CameraUp                    = 0x10081217
	KEY_CameraDown                  = 0x10081218
	KEY_CameraLeft                  = 0x10081219
	KEY_CameraRight                 = 0x1008121a
	KEY_AttendantOn                 = 0x1008121b
	KEY_AttendantOff                = 0x1008121c
	KEY_AttendantToggle             = 0x1008121d
	KEY_LightsToggle                = 0x1008121e
	KEY_ALSToggle                   = 0x10081230
	KEY_RefreshRateToggle           = 0x10081232
	KEY_Buttonconfig                = 0x10081240
	KEY_Taskmanager                 = 0x10081241
	KEY_Journal                     = 0x10081242
	KEY_ControlPanel                = 0x10081243
	KEY_AppSelect                   = 0x10081244
	KEY_Screensaver                 = 0x10081245
	KEY_VoiceCommand                = 0x10081246
	KEY_Assistant                   = 0x10081247
	KEY_EmojiPicker                 = 0x10081249
	KEY_Dictate                     = 0x1008124a
	KEY_CameraAccessEnable          = 0x1008124b
	KEY_CameraAccessDisable         = 0x1008124c
	KEY_CameraAccessToggle          = 0x1008124d
	KEY_Accessibility               = 0x1008124e
	KEY_DoNotDisturb                = 0x1008124f
	KEY_BrightnessMin               = 0x10081250
	KEY_BrightnessMax               = 0x10081251
	KEY_KbdInputAssistPrev          = 0x10081260
	KEY_KbdInputAssistNext          = 0x10081261
	KEY_KbdInputAssistPrevgroup     = 0x10081262
	KEY_KbdInputAssistNextgroup     = 0x10081263
	KEY_KbdInputAssistAccept        = 0x10081264
	KEY_KbdInputAssistCancel        = 0x10081265
	KEY_RightUp                     = 0x10081266
	KEY_RightDown                   = 0x10081267
	KEY_LeftUp                      = 0x10081268
	KEY_LeftDown                    = 0x10081269
	KEY_RootMenu                    = 0x1008126a
	KEY_MediaTopMenu                = 0x1008126b
	KEY_Numeric11                   = 0x1008126c
	KEY_Numeric12                   = 0x1008126d
	KEY_AudioDesc                   = 0x1008126e
	KEY_3DMode                      = 0x1008126f
	KEY_NextFavorite                = 0x10081270
	KEY_StopRecord                  = 0x10081271
	KEY_PauseRecord                 = 0x10081272
	KEY_VOD                         = 0x10081273
	KEY_Unmute                      = 0x10081274
	KEY_FastReverse                 = 0x10081275
	KEY_SlowReverse                 = 0x10081276
	KEY_Data                        = 0x10081277
	KEY_OnScreenKeyboard            = 0x10081278
	KEY_PrivacyScreenToggle         = 0x10081279
	KEY_SelectiveScreenshot         = 0x1008127a
	KEY_NextElement                 = 0x1008127b
	KEY_PreviousElement             = 0x1008127c
	KEY_AutopilotEngageToggle       = 0x1008127d
	KEY_MarkWaypoint                = 0x1008127e
	KEY_Sos                         = 0x1008127f
	KEY_NavChart                    = 0x10081280
	KEY_FishingChart                = 0x10081281
	KEY_SingleRangeRadar            = 0x10081282
	KEY_DualRangeRadar              = 0x10081283
	KEY_RadarOverlay                = 0x10081284
	KEY_TraditionalSonar            = 0x10081285
	KEY_ClearvuSonar                = 0x10081286
	KEY_SidevuSonar                 = 0x10081287
	KEY_NavInfo                     = 0x10081288
	KEY_Macro1                      = 0x10081290
	KEY_Macro2                      = 0x10081291
	KEY_Macro3                      = 0x10081292
	KEY_Macro4                      = 0x10081293
	KEY_Macro5                      = 0x10081294
	KEY_Macro6                      = 0x10081295
	KEY_Macro7                      = 0x10081296
	KEY_Macro8                      = 0x10081297
	KEY_Macro9                      = 0x10081298
	KEY_Macro10                     = 0x10081299
	KEY_Macro11                     = 0x1008129a
	KEY_Macro12                     = 0x1008129b
	KEY_Macro13                     = 0x1008129c
	KEY_Macro14                     = 0x1008129d
	KEY_Macro15                     = 0x1008129e
	KEY_Macro16                     = 0x1008129f
	KEY_Macro17                     = 0x100812a0
	KEY_Macro18                     = 0x100812a1
	KEY_Macro19                     = 0x100812a2
	KEY_Macro20                     = 0x100812a3
	KEY_Macro21                     = 0x100812a4
	KEY_Macro22                     = 0x100812a5
	KEY_Macro23                     = 0x100812a6
	KEY_Macro24                     = 0x100812a7
	KEY_Macro25                     = 0x100812a8
	KEY_Macro26                     = 0x100812a9
	KEY_Macro27                     = 0x100812aa
	KEY_Macro28                     = 0x100812ab
	KEY_Macro29                     = 0x100812ac
	KEY_Macro30                     = 0x100812ad
	KEY_MacroRecordStart            = 0x100812b0
	KEY_MacroRecordStop             = 0x100812b1
	KEY_MacroPresetCycle            = 0x100812b2
	KEY_MacroPreset1                = 0x100812b3
	KEY_MacroPreset2                = 0x100812b4
	KEY_MacroPreset3                = 0x100812b5
	KEY_KbdLcdMenu1                 = 0x100812b8
	KEY_KbdLcdMenu2                 = 0x100812b9
	KEY_KbdLcdMenu3                 = 0x100812ba
	KEY_KbdLcdMenu4                 = 0x100812bb
	KEY_KbdLcdMenu5                 = 0x100812bc
)
