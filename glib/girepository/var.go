...
var (
	...
	gi_arg_info_is_return_value        = cc.DlFunc[func(*ArgInfo) bool, bool]{Name: "gi_arg_info_is_return_value"}
	gi_arg_info_is_optional            = cc.DlFunc[func(*ArgInfo) bool, bool]{Name: "gi_arg_info_is_optional"}
	gi_arg_info_is_caller_allocates    = cc.DlFunc[func(*ArgInfo) bool, bool]{Name: "gi_arg_info_is_caller_allocates"}
	gi_arg_info_may_be_null            = cc.DlFunc[func(*ArgInfo) bool, bool]{Name: "gi_arg_info_may_be_null"}
	gi_arg_info_is_skip                = cc.DlFunc[func(*ArgInfo) bool, bool]{Name: "gi_arg_info_is_skip"}
	...
	gi_arg_info_get_closure_index      = cc.DlFunc[func(*ArgInfo, *uint32) bool, bool]{Name: "gi_arg_info_get_closure_index"}
	gi_arg_info_get_destroy_index      = cc.DlFunc[func(*ArgInfo, *uint32) bool, bool]{Name: "gi_arg_info_get_destroy_index"}
	...
	gi_base_info_get_name           = cc.DlFunc[func(*BaseInfo) string, string]{Name: "gi_base_info_get_name"}
	gi_base_info_get_namespace      = cc.DlFunc[func(*BaseInfo) string, string]{Name: "gi_base_info_get_namespace"}
	gi_base_info_is_deprecated      = cc.DlFunc[func(*BaseInfo) bool, bool]{Name: "gi_base_info_is_deprecated"}
	gi_base_info_get_attribute      = cc.DlFunc[func(*BaseInfo, string) string, string]{Name: "gi_base_info_get_attribute"}
	...
	gi_base_info_equal              = cc.DlFunc[func(*BaseInfo, *BaseInfo) bool, bool]{Name: "gi_base_info_equal"}

	gi_callable_info_is_method                 = cc.DlFunc[func(*CallableInfo) bool, bool]{Name: "gi_callable_info_is_method"}
	gi_callable_info_can_throw_gerror          = cc.DlFunc[func(*CallableInfo) bool, bool]{Name: "gi_callable_info_can_throw_gerror"}
	...
	gi_callable_info_get_return_attribute      = cc.DlFunc[func(*CallableInfo, string) string, string]{Name: "gi_callable_info_get_return_attribute"}
	gi_callable_info_iterate_return_attributes = cc.DlFunc[func(*CallableInfo, *AttributeIter, *cc.String, *cc.String) bool, bool]{Name: "gi_callable_info_iterate_return_attributes"}
	gi_callable_info_get_caller_owns           = cc.DlFunc[func(*CallableInfo) Transfer, Transfer]{Name: "gi_callable_info_get_caller_owns"}
	gi_callable_info_may_return_null           = cc.DlFunc[func(*CallableInfo) bool, bool]{Name: "gi_callable_info_may_return_null"}
	gi_callable_info_skip_return               = cc.DlFunc[func(*CallableInfo) bool, bool]{Name: "gi_callable_info_skip_return"}
	...
	// gi_callable_info_invoke                          func(*CallableInfo, uptr, uptr, uint, uptr, uint, uptr, **glib.GError) bool
	...
	gi_enum_info_get_error_domain = cc.DlFunc[func(*EnumInfo) string, string]{Name: "gi_enum_info_get_error_domain"}
	...
	gi_field_info_get_field     = cc.DlFunc[func(*FieldInfo, uptr, *Argument) bool, bool]{Name: "gi_field_info_get_field"}
	gi_field_info_set_field     = cc.DlFunc[func(*FieldInfo, uptr, *Argument) bool, bool]{Name: "gi_field_info_set_field"}

	gi_function_info_get_symbol   = cc.DlFunc[func(*FunctionInfo) string, string]{Name: "gi_function_info_get_symbol"}
	...
	// gi_function_info_invoke       func(*FunctionInfo, *Argument, uint, *Argument, uint, *Argument, **glib.GError) bool
	...
	gi_interface_info_find_method         = cc.DlFunc[func(*InterfaceInfo, string) *FunctionInfo, *FunctionInfo]{Name: "gi_interface_info_find_method"}
	...
	gi_interface_info_find_signal         = cc.DlFunc[func(*InterfaceInfo, string) *SignalInfo, *SignalInfo]{Name: "gi_interface_info_find_signal"}
	...
	gi_interface_info_find_vfunc          = cc.DlFunc[func(*InterfaceInfo, string) *VFuncInfo, *VFuncInfo]{Name: "gi_interface_info_find_vfunc"}
	...
	gi_object_info_get_type_name                  = cc.DlFunc[func(*ObjectInfo) string, string]{Name: "gi_object_info_get_type_name"}
	gi_object_info_get_type_init_function_name    = cc.DlFunc[func(*ObjectInfo) string, string]{Name: "gi_object_info_get_type_init_function_name"}
	gi_object_info_get_abstract                   = cc.DlFunc[func(*ObjectInfo) bool, bool]{Name: "gi_object_info_get_abstract"}
	gi_object_info_get_final                      = cc.DlFunc[func(*ObjectInfo) bool, bool]{Name: "gi_object_info_get_final"}
	gi_object_info_get_fundamental                = cc.DlFunc[func(*ObjectInfo) bool, bool]{Name: "gi_object_info_get_fundamental"}
	...
	gi_object_info_find_method                    = cc.DlFunc[func(*ObjectInfo, string) *FunctionInfo, *FunctionInfo]{Name: "gi_object_info_find_method"}
	gi_object_info_find_method_using_interfaces   = cc.DlFunc[func(*ObjectInfo, string, **BaseInfo) *FunctionInfo, *FunctionInfo]{Name: "gi_object_info_find_method_using_interfaces"}
	...
	gi_object_info_find_signal                    = cc.DlFunc[func(*ObjectInfo, string) *SignalInfo, *SignalInfo]{Name: "gi_object_info_find_signal"}
	...
	gi_object_info_find_vfunc                     = cc.DlFunc[func(*ObjectInfo, string) *VFuncInfo, *VFuncInfo]{Name: "gi_object_info_find_vfunc"}
	gi_object_info_find_vfunc_using_interfaces    = cc.DlFunc[func(*ObjectInfo, string, **BaseInfo) *VFuncInfo, *VFuncInfo]{Name: "gi_object_info_find_vfunc_using_interfaces"}
	...
	gi_object_info_get_ref_function_name          = cc.DlFunc[func(*ObjectInfo) string, string]{Name: "gi_object_info_get_ref_function_name"}
	gi_object_info_get_ref_function_pointer       = cc.DlFunc[func(*ObjectInfo) uptr, uptr]{Name: "gi_object_info_get_ref_function_pointer"}
	gi_object_info_get_unref_function_name        = cc.DlFunc[func(*ObjectInfo) string, string]{Name: "gi_object_info_get_unref_function_name"}
	...
	gi_object_info_get_set_value_function_name    = cc.DlFunc[func(*ObjectInfo) string, string]{Name: "gi_object_info_get_set_value_function_name"}
	...
	gi_object_info_get_get_value_function_name    = cc.DlFunc[func(*ObjectInfo) string, string]{Name: "gi_object_info_get_get_value_function_name"}
	...
	gi_registered_type_info_get_type_name               = cc.DlFunc[func(*RegisteredTypeInfo) string, string]{Name: "gi_registered_type_info_get_type_name"}
	gi_registered_type_info_get_type_init_function_name = cc.DlFunc[func(*RegisteredTypeInfo) string, string]{Name: "gi_registered_type_info_get_type_init_function_name"}
	...
	gi_registered_type_info_is_boxed                    = cc.DlFunc[func(*RegisteredTypeInfo) bool, bool]{Name: "gi_registered_type_info_is_boxed"}

	gi_repository_new                         = cc.DlFunc[func() *Repository, *Repository]{Name: "gi_repository_new"}
	gi_repository_prepend_search_path         = cc.DlFunc[func(*Repository, string), cc.Void]{Name: "gi_repository_prepend_search_path"}
	gi_repository_prepend_library_path        = cc.DlFunc[func(*Repository, string), cc.Void]{Name: "gi_repository_prepend_library_path"}
	...
	gi_repository_load_typelib                = cc.DlFunc[func(*Repository, *Typelib, RepositoryLoadFlags, **glib.GError) string, string]{Name: "gi_repository_load_typelib"}
	gi_repository_is_registered               = cc.DlFunc[func(*Repository, string, string) bool, bool]{Name: "gi_repository_is_registered"}
	gi_repository_find_by_name                = cc.DlFunc[func(*Repository, string, string) *BaseInfo, *BaseInfo]{Name: "gi_repository_find_by_name"}
	gi_repository_enumerate_versions          = cc.DlFunc[func(*Repository, string, *uint64) cc.Strings, cc.Strings]{Name: "gi_repository_enumerate_versions"}
	gi_repository_require                     = cc.DlFunc[func(*Repository, string, string, RepositoryLoadFlags, **glib.GError) *Typelib, *Typelib]{Name: "gi_repository_require"}
	gi_repository_require_private             = cc.DlFunc[func(*Repository, string, string, string, RepositoryLoadFlags, **glib.GError) *Typelib, *Typelib]{Name: "gi_repository_require_private"}
	gi_repository_get_immediate_dependencies  = cc.DlFunc[func(*Repository, string, *uint64) cc.Strings, cc.Strings]{Name: "gi_repository_get_immediate_dependencies"}
	gi_repository_get_dependencies            = cc.DlFunc[func(*Repository, string, *uint64) cc.Strings, cc.Strings]{Name: "gi_repository_get_dependencies"}
	...
	gi_repository_get_n_infos                 = cc.DlFunc[func(*Repository, string) uint32, uint32]{Name: "gi_repository_get_n_infos"}
	gi_repository_get_info                    = cc.DlFunc[func(*Repository, string, uint32) *BaseInfo, *BaseInfo]{Name: "gi_repository_get_info"}
	...
	gi_repository_get_typelib_path            = cc.DlFunc[func(*Repository, string) string, string]{Name: "gi_repository_get_typelib_path"}
	gi_repository_get_shared_libraries        = cc.DlFunc[func(*Repository, string, *uint64) cc.Strings, cc.Strings]{Name: "gi_repository_get_shared_libraries"}
	gi_repository_get_c_prefix                = cc.DlFunc[func(*Repository, string) string, string]{Name: "gi_repository_get_c_prefix"}
	gi_repository_get_version                 = cc.DlFunc[func(*Repository, string) string, string]{Name: "gi_repository_get_version"}
	gi_repository_get_option_group            = cc.DlFunc[func() *glib.GOptionGroup, *glib.GOptionGroup]{Name: "gi_repository_get_option_group"}
	gi_repository_dump                        = cc.DlFunc[func(string, string, **glib.GError) bool, bool]{Name: "gi_repository_dump"}
	...
	gi_signal_info_true_stops_emit   = cc.DlFunc[func(*SignalInfo) bool, bool]{Name: "gi_signal_info_true_stops_emit"}
	...
	gi_struct_info_find_field             = cc.DlFunc[func(*StructInfo, string) *FieldInfo, *FieldInfo]{Name: "gi_struct_info_find_field"}
	...
	gi_struct_info_find_method            = cc.DlFunc[func(*StructInfo, string) *FunctionInfo, *FunctionInfo]{Name: "gi_struct_info_find_method"}
	...
	gi_struct_info_is_gtype_struct        = cc.DlFunc[func(*StructInfo) bool, bool]{Name: "gi_struct_info_is_gtype_struct"}
	gi_struct_info_is_foreign             = cc.DlFunc[func(*StructInfo) bool, bool]{Name: "gi_struct_info_is_foreign"}
	gi_struct_info_get_copy_function_name = cc.DlFunc[func(*StructInfo) string, string]{Name: "gi_struct_info_get_copy_function_name"}
	gi_struct_info_get_free_function_name = cc.DlFunc[func(*StructInfo) string, string]{Name: "gi_struct_info_get_free_function_name"}

	gi_type_tag_to_string                   = cc.DlFunc[func(int32) string, string]{Name: "gi_type_tag_to_string"}
	gi_type_info_is_pointer                 = cc.DlFunc[func(*TypeInfo) bool, bool]{Name: "gi_type_info_is_pointer"}
	...
	gi_type_info_get_array_length_index     = cc.DlFunc[func(*TypeInfo, *uint32) bool, bool]{Name: "gi_type_info_get_array_length_index"}
	gi_type_info_get_array_fixed_size       = cc.DlFunc[func(*TypeInfo, *uint) bool, bool]{Name: "gi_type_info_get_array_fixed_size"}
	gi_type_info_is_zero_terminated         = cc.DlFunc[func(*TypeInfo) bool, bool]{Name: "gi_type_info_is_zero_terminated"}
	...
	gi_union_info_is_discriminated         = cc.DlFunc[func(*UnionInfo) bool, bool]{Name: "gi_union_info_is_discriminated"}
	gi_union_info_get_discriminator_offset = cc.DlFunc[func(*UnionInfo, *uint) bool, bool]{Name: "gi_union_info_get_discriminator_offset"}
	...
	gi_union_info_find_method              = cc.DlFunc[func(*UnionInfo, string) *FunctionInfo, *FunctionInfo]{Name: "gi_union_info_find_method"}
	...
	gi_union_info_get_copy_function_name   = cc.DlFunc[func(*UnionInfo) string, string]{Name: "gi_union_info_get_copy_function_name"}
	gi_union_info_get_free_function_name   = cc.DlFunc[func(*UnionInfo) string, string]{Name: "gi_union_info_get_free_function_name"}
	...
	gi_typelib_symbol         = cc.DlFunc[func(*Typelib, string, *uptr) bool, bool]{Name: "gi_typelib_symbol"}
	gi_typelib_get_namespace  = cc.DlFunc[func(*Typelib) string, string]{Name: "gi_typelib_get_namespace"}
