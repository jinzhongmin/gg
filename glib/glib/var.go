...
var (
	...
	// #region Array
	g_array_new                                = cc.DlFunc[func(zeroTerminated, clear bool, elementSize uint32) *GArray, *GArray]{Name: "g_array_new"}
	g_array_new_take                           = cc.DlFunc[func(data UPtr, length uint64, clear bool, elementSize uint64) *GArray, *GArray]{Name: "g_array_new_take"}
	g_array_new_take_zero_terminated           = cc.DlFunc[func(data UPtr, clear bool, elementSize uint64) *GArray, *GArray]{Name: "g_array_new_take_zero_terminated"}
	g_array_steal                              = cc.DlFunc[func(array *GArray, length *uint64) UPtr, UPtr]{Name: "g_array_steal"}
	g_array_sized_new                          = cc.DlFunc[func(zeroTerminated, clear bool, elementSize, reservedSize uint32) *GArray, *GArray]{Name: "g_array_sized_new"}
	g_array_copy                               = cc.DlFunc[func(array *GArray) *GArray, *GArray]{Name: "g_array_copy"}
	g_array_free                               = cc.DlFunc[func(array *GArray, freeSegment bool) UPtr, UPtr]{Name: "g_array_free"}
	g_array_ref                                = cc.DlFunc[func(array *GArray) *GArray, *GArray]{Name: "g_array_ref"}
	g_array_unref                              = cc.DlFunc[func(array *GArray), cc.Void]{Name: "g_array_unref"}
	g_array_get_element_size                   = cc.DlFunc[func(array *GArray) uint32, uint32]{Name: "g_array_get_element_size"}
	g_array_append_vals                        = cc.DlFunc[func(array *GArray, data UPtr, length uint32) *GArray, *GArray]{Name: "g_array_append_vals"}
	g_array_prepend_vals                       = cc.DlFunc[func(array *GArray, data UPtr, length uint32) *GArray, *GArray]{Name: "g_array_prepend_vals"}
	g_array_insert_vals                        = cc.DlFunc[func(array *GArray, index uint32, data UPtr, length uint32) *GArray, *GArray]{Name: "g_array_insert_vals"}
	g_array_set_size                           = cc.DlFunc[func(array *GArray, length uint32) *GArray, *GArray]{Name: "g_array_set_size"}
	g_array_remove_index                       = cc.DlFunc[func(array *GArray, index uint32) *GArray, *GArray]{Name: "g_array_remove_index"}
	g_array_remove_index_fast                  = cc.DlFunc[func(array *GArray, index uint32) *GArray, *GArray]{Name: "g_array_remove_index_fast"}
	g_array_remove_range                       = cc.DlFunc[func(array *GArray, index uint32, length uint32) *GArray, *GArray]{Name: "g_array_remove_range"}
	g_array_sort                               = cc.DlFunc[func(array *GArray, compareFunc UPtr), cc.Void]{Name: "g_array_sort"}
	g_array_binary_search                      = cc.DlFunc[func(array *GArray, target UPtr, compareFunc UPtr, outMatchIndex *uint32) bool, bool]{Name: "g_array_binary_search"}
	g_array_set_clear_func                     = cc.DlFunc[func(array *GArray, clearFunc UPtr), cc.Void]{Name: "g_array_set_clear_func"}
	g_ptr_array_new                            = cc.DlFunc[func() *GPtrArray, *GPtrArray]{Name: "g_ptr_array_new"}
	g_ptr_array_new_with_free_func             = cc.DlFunc[func(elementFreeFunc UPtr) *GPtrArray, *GPtrArray]{Name: "g_ptr_array_new_with_free_func"}
	g_ptr_array_new_take                       = cc.DlFunc[func(data UPtr, length uint64, elementFreeFunc UPtr) *GPtrArray, *GPtrArray]{Name: "g_ptr_array_new_take"}
	g_ptr_array_new_from_array                 = cc.DlFunc[func(data UPtr, length uint64, copyFunc UPtr, copyFuncUserData UPtr, elementFreeFunc UPtr) *GPtrArray, *GPtrArray]{Name: "g_ptr_array_new_from_array"}
	g_ptr_array_steal                          = cc.DlFunc[func(array *GPtrArray, length *uint64) UPtr, UPtr]{Name: "g_ptr_array_steal"}
	g_ptr_array_copy                           = cc.DlFunc[func(array *GPtrArray, copyFunc UPtr, userData UPtr) *GPtrArray, *GPtrArray]{Name: "g_ptr_array_copy"}
	g_ptr_array_sized_new                      = cc.DlFunc[func(reservedSize uint32) *GPtrArray, *GPtrArray]{Name: "g_ptr_array_sized_new"}
	g_ptr_array_new_full                       = cc.DlFunc[func(reservedSize uint32, elementFreeFunc UPtr) *GPtrArray, *GPtrArray]{Name: "g_ptr_array_new_full"}
	g_ptr_array_new_null_terminated            = cc.DlFunc[func(reservedSize uint32, elementFreeFunc UPtr, nullTerminated bool) *GPtrArray, *GPtrArray]{Name: "g_ptr_array_new_null_terminated"}
	g_ptr_array_new_take_null_terminated       = cc.DlFunc[func(data UPtr, elementFreeFunc UPtr) *GPtrArray, *GPtrArray]{Name: "g_ptr_array_new_take_null_terminated"}
	g_ptr_array_new_from_null_terminated_array = cc.DlFunc[func(data UPtr, copyFunc UPtr, copyFuncUserData UPtr, elementFreeFunc UPtr) *GPtrArray, *GPtrArray]{Name: "g_ptr_array_new_from_null_terminated_array"}
	g_ptr_array_free                           = cc.DlFunc[func(array *GPtrArray, freeSegment bool) UPtr, UPtr]{Name: "g_ptr_array_free"}
	g_ptr_array_ref                            = cc.DlFunc[func(array *GPtrArray) *GPtrArray, *GPtrArray]{Name: "g_ptr_array_ref"}
	g_ptr_array_unref                          = cc.DlFunc[func(array *GPtrArray), cc.Void]{Name: "g_ptr_array_unref"}
	g_ptr_array_set_free_func                  = cc.DlFunc[func(array *GPtrArray, elementFreeFunc UPtr), cc.Void]{Name: "g_ptr_array_set_free_func"}
	g_ptr_array_set_size                       = cc.DlFunc[func(array *GPtrArray, length int32), cc.Void]{Name: "g_ptr_array_set_size"}
	g_ptr_array_remove_index                   = cc.DlFunc[func(array *GPtrArray, index uint32) UPtr, UPtr]{Name: "g_ptr_array_remove_index"}
	g_ptr_array_remove_index_fast              = cc.DlFunc[func(array *GPtrArray, index uint32) UPtr, UPtr]{Name: "g_ptr_array_remove_index_fast"}
	g_ptr_array_steal_index                    = cc.DlFunc[func(array *GPtrArray, index uint32) UPtr, UPtr]{Name: "g_ptr_array_steal_index"}
	g_ptr_array_steal_index_fast               = cc.DlFunc[func(array *GPtrArray, index uint32) UPtr, UPtr]{Name: "g_ptr_array_steal_index_fast"}
	g_ptr_array_remove                         = cc.DlFunc[func(array *GPtrArray, data UPtr) bool, bool]{Name: "g_ptr_array_remove"}
	g_ptr_array_remove_fast                    = cc.DlFunc[func(array *GPtrArray, data UPtr) bool, bool]{Name: "g_ptr_array_remove_fast"}
	g_ptr_array_remove_range                   = cc.DlFunc[func(array *GPtrArray, index uint32, length uint32) *GPtrArray, *GPtrArray]{Name: "g_ptr_array_remove_range"}
	g_ptr_array_add                            = cc.DlFunc[func(array *GPtrArray, data UPtr), cc.Void]{Name: "g_ptr_array_add"}
	g_ptr_array_extend                         = cc.DlFunc[func(arrayToExtend, array *GPtrArray, copyFunc UPtr, userData UPtr), cc.Void]{Name: "g_ptr_array_extend"}
	g_ptr_array_extend_and_steal               = cc.DlFunc[func(arrayToExtend, array *GPtrArray), cc.Void]{Name: "g_ptr_array_extend_and_steal"}
	g_ptr_array_insert                         = cc.DlFunc[func(array *GPtrArray, index int32, data UPtr), cc.Void]{Name: "g_ptr_array_insert"}
	g_ptr_array_sort                           = cc.DlFunc[func(array *GPtrArray, compareFunc UPtr), cc.Void]{Name: "g_ptr_array_sort"}
	g_ptr_array_sort_with_data                 = cc.DlFunc[func(array *GPtrArray, compareFunc UPtr, userData UPtr), cc.Void]{Name: "g_ptr_array_sort_with_data"}
	g_ptr_array_sort_values                    = cc.DlFunc[func(array *GPtrArray, compareFunc UPtr), cc.Void]{Name: "g_ptr_array_sort_values"}
	g_ptr_array_sort_values_with_data          = cc.DlFunc[func(array *GPtrArray, compareFunc UPtr, userData UPtr), cc.Void]{Name: "g_ptr_array_sort_values_with_data"}
	g_ptr_array_foreach                        = cc.DlFunc[func(array *GPtrArray, fn UPtr, userData UPtr), cc.Void]{Name: "g_ptr_array_foreach"}
	g_ptr_array_find                           = cc.DlFunc[func(haystack *GPtrArray, needle UPtr, index *uint32) bool, bool]{Name: "g_ptr_array_find"}
	g_ptr_array_find_with_equal_func           = cc.DlFunc[func(haystack *GPtrArray, needle UPtr, equalFunc UPtr, index *uint32) bool, bool]{Name: "g_ptr_array_find_with_equal_func"}
	g_ptr_array_is_null_terminated             = cc.DlFunc[func(array *GPtrArray) bool, bool]{Name: "g_ptr_array_is_null_terminated"}
	...
	g_byte_array_free                          = cc.DlFunc[func(array *GByteArray, freeSegment bool) UPtr, UPtr]{Name: "g_byte_array_free"}
	...
	g_async_queue_new_full             = cc.DlFunc[func(itemFreeFunc UPtr) *GAsyncQueue, *GAsyncQueue]{Name: "g_async_queue_new_full"}
	...
	// #region Bytes
	g_bytes_new            = cc.DlFunc[func(data UPtr, size uint) *GBytes, *GBytes]{Name: "g_bytes_new"}
	g_bytes_new_static     = cc.DlFunc[func(data UPtr, size uint) *GBytes, *GBytes]{Name: "g_bytes_new_static"}
	...
	g_bytes_get_data       = cc.DlFunc[func(*GBytes, *uint) UPtr, UPtr]{Name: "g_bytes_get_data"}
	g_bytes_get_region     = cc.DlFunc[func(*GBytes, uint, uint) UPtr, UPtr]{Name: "g_bytes_get_region"}
	g_bytes_get_size       = cc.DlFunc[func(*GBytes) uint, uint]{Name: "g_bytes_get_size"}
	g_bytes_hash           = cc.DlFunc[func(*GBytes) uint, uint]{Name: "g_bytes_hash"}
	g_bytes_new_from_bytes = cc.DlFunc[func(*GBytes, uint, uint) *GBytes, *GBytes]{Name: "g_bytes_new_from_bytes"}
	...
	g_bytes_unref_to_data  = cc.DlFunc[func(*GBytes, *uint) UPtr, UPtr]{Name: "g_bytes_unref_to_data"}
	// #endregion

	// #region Error
	g_error_new                    = cc.DlFunc[func(GQuark, int32, string) *GError, *GError]{Name: "g_error_new"}
	g_error_domain_register        = cc.DlFunc[func(string, uint, UPtr, UPtr, UPtr) GQuark, GQuark]{Name: "g_error_domain_register"}
	g_error_domain_register_static = cc.DlFunc[func(string, uint, UPtr, UPtr, UPtr) GQuark, GQuark]{Name: "g_error_domain_register_static"}
	...
	// #region List
	g_list_alloc     = cc.DlFunc[func() *GList, *GList]{Name: "g_list_alloc"}
	g_list_free      = cc.DlFunc[func(*GList), cc.Void]{Name: "g_list_free"}
	g_list_free_1    = cc.DlFunc[func(*GList), cc.Void]{Name: "g_list_free_1"}
	g_list_free_full = cc.DlFunc[func(*GList, UPtr), cc.Void]{Name: "g_list_free_full"}
	g_list_append    = cc.DlFunc[func(*GList, UPtr) *GList, *GList]{Name: "g_list_append"}
	g_list_prepend   = cc.DlFunc[func(*GList, UPtr) *GList, *GList]{Name: "g_list_prepend"}
	g_list_insert    = cc.DlFunc[func(*GList, UPtr, int32) *GList, *GList]{Name: "g_list_insert"}

	g_list_insert_sorted           = cc.DlFunc[func(*GList, UPtr, UPtr) *GList, *GList]{Name: "g_list_insert_sorted"}
	g_list_insert_sorted_with_data = cc.DlFunc[func(*GList, UPtr, UPtr, UPtr) *GList, *GList]{Name: "g_list_insert_sorted_with_data"}
	g_list_insert_before           = cc.DlFunc[func(*GList, *GList, UPtr) *GList, *GList]{Name: "g_list_insert_before"}
	g_list_insert_before_link      = cc.DlFunc[func(*GList, *GList, *GList) *GList, *GList]{Name: "g_list_insert_before_link"}
	g_list_concat                  = cc.DlFunc[func(*GList, *GList) *GList, *GList]{Name: "g_list_concat"}
	g_list_remove                  = cc.DlFunc[func(*GList, UPtr) *GList, *GList]{Name: "g_list_remove"}
	g_list_remove_all              = cc.DlFunc[func(*GList, UPtr) *GList, *GList]{Name: "g_list_remove_all"}
	g_list_remove_link             = cc.DlFunc[func(*GList, *GList) *GList, *GList]{Name: "g_list_remove_link"}
	g_list_delete_link             = cc.DlFunc[func(*GList, *GList) *GList, *GList]{Name: "g_list_delete_link"}

	g_list_reverse        = cc.DlFunc[func(*GList) *GList, *GList]{Name: "g_list_reverse"}
	g_list_copy           = cc.DlFunc[func(*GList) *GList, *GList]{Name: "g_list_copy"}
	g_list_copy_deep      = cc.DlFunc[func(*GList, UPtr, UPtr) *GList, *GList]{Name: "g_list_copy_deep"}
	g_list_nth            = cc.DlFunc[func(*GList, uint32) *GList, *GList]{Name: "g_list_nth"}
	g_list_nth_prev       = cc.DlFunc[func(*GList, uint32) *GList, *GList]{Name: "g_list_nth_prev"}
	g_list_find           = cc.DlFunc[func(*GList, UPtr) *GList, *GList]{Name: "g_list_find"}
	g_list_find_custom    = cc.DlFunc[func(*GList, UPtr, UPtr) *GList, *GList]{Name: "g_list_find_custom"}
	g_list_position       = cc.DlFunc[func(*GList, *GList) int32, int32]{Name: "g_list_position"}
	g_list_index          = cc.DlFunc[func(*GList, UPtr) int32, int32]{Name: "g_list_index"}
	g_list_last           = cc.DlFunc[func(*GList) *GList, *GList]{Name: "g_list_last"}
	g_list_first          = cc.DlFunc[func(*GList) *GList, *GList]{Name: "g_list_first"}
	g_list_length         = cc.DlFunc[func(*GList) uint32, uint32]{Name: "g_list_length"}
	g_list_foreach        = cc.DlFunc[func(*GList, UPtr, UPtr), cc.Void]{Name: "g_list_foreach"}
	g_list_sort           = cc.DlFunc[func(*GList, UPtr) *GList, *GList]{Name: "g_list_sort"}
	g_list_sort_with_data = cc.DlFunc[func(*GList, UPtr, UPtr) *GList, *GList]{Name: "g_list_sort_with_data"}
	g_list_nth_data       = cc.DlFunc[func(*GList, uint32) UPtr, UPtr]{Name: "g_list_nth_data"}
	g_clear_list          = cc.DlFunc[func(**GList, UPtr), cc.Void]{Name: "g_clear_list"}
	// #endregion

	// #region Main
	g_main_context_new                            = cc.DlFunc[func() *GMainContext, *GMainContext]{Name: "g_main_context_new"}
	g_main_context_new_with_flags                 = cc.DlFunc[func(flags uint32) *GMainContext, *GMainContext]{Name: "g_main_context_new_with_flags"}
	...
	// #region Quark
	g_quark_try_string         = cc.DlFunc[func(string) GQuark, GQuark]{Name: "g_quark_try_string"}
	g_quark_from_static_string = cc.DlFunc[func(string) GQuark, GQuark]{Name: "g_quark_from_static_string"}
	g_quark_from_string        = cc.DlFunc[func(string) GQuark, GQuark]{Name: "g_quark_from_string"}
	g_quark_to_string          = cc.DlFunc[func(GQuark) string, string]{Name: "g_quark_to_string"}
	// #endregion

	// #region SList
	g_slist_alloc                   = cc.DlFunc[func() *GSList, *GSList]{Name: "g_slist_alloc"}
	g_slist_free                    = cc.DlFunc[func(list *GSList), cc.Void]{Name: "g_slist_free"}
	g_slist_free_1                  = cc.DlFunc[func(list *GSList), cc.Void]{Name: "g_slist_free_1"}
	g_slist_free_full               = cc.DlFunc[func(list *GSList, freeFunc UPtr), cc.Void]{Name: "g_slist_free_full"}
	g_slist_append                  = cc.DlFunc[func(list *GSList, data UPtr) *GSList, *GSList]{Name: "g_slist_append"}
	g_slist_prepend                 = cc.DlFunc[func(list *GSList, data UPtr) *GSList, *GSList]{Name: "g_slist_prepend"}
	g_slist_insert                  = cc.DlFunc[func(list *GSList, data UPtr, position int32) *GSList, *GSList]{Name: "g_slist_insert"}
	g_slist_insert_sorted           = cc.DlFunc[func(list *GSList, data UPtr, compareFunc UPtr) *GSList, *GSList]{Name: "g_slist_insert_sorted"}
	g_slist_insert_sorted_with_data = cc.DlFunc[func(list *GSList, data UPtr, compareDataFunc UPtr, userData UPtr) *GSList, *GSList]{Name: "g_slist_insert_sorted_with_data"}
	g_slist_insert_before           = cc.DlFunc[func(slist *GSList, sibling *GSList, data UPtr) *GSList, *GSList]{Name: "g_slist_insert_before"}
	g_slist_concat                  = cc.DlFunc[func(list1 *GSList, list2 *GSList) *GSList, *GSList]{Name: "g_slist_concat"}
	g_slist_remove                  = cc.DlFunc[func(list *GSList, data UPtr) *GSList, *GSList]{Name: "g_slist_remove"}
	g_slist_remove_all              = cc.DlFunc[func(list *GSList, data UPtr) *GSList, *GSList]{Name: "g_slist_remove_all"}
	g_slist_remove_link             = cc.DlFunc[func(list *GSList, link *GSList) *GSList, *GSList]{Name: "g_slist_remove_link"}
	g_slist_delete_link             = cc.DlFunc[func(list *GSList, link *GSList) *GSList, *GSList]{Name: "g_slist_delete_link"}
	g_slist_reverse                 = cc.DlFunc[func(list *GSList) *GSList, *GSList]{Name: "g_slist_reverse"}
	g_slist_copy                    = cc.DlFunc[func(list *GSList) *GSList, *GSList]{Name: "g_slist_copy"}
	g_slist_copy_deep               = cc.DlFunc[func(list *GSList, copyFunc UPtr, userData UPtr) *GSList, *GSList]{Name: "g_slist_copy_deep"}
	g_slist_nth                     = cc.DlFunc[func(list *GSList, n uint32) *GSList, *GSList]{Name: "g_slist_nth"}
	g_slist_find                    = cc.DlFunc[func(list *GSList, data UPtr) *GSList, *GSList]{Name: "g_slist_find"}
	g_slist_find_custom             = cc.DlFunc[func(list *GSList, data UPtr, compareFunc UPtr) *GSList, *GSList]{Name: "g_slist_find_custom"}
	g_slist_position                = cc.DlFunc[func(list *GSList, llink *GSList) int32, int32]{Name: "g_slist_position"}
	g_slist_index                   = cc.DlFunc[func(list *GSList, data UPtr) int32, int32]{Name: "g_slist_index"}
	g_slist_last                    = cc.DlFunc[func(list *GSList) *GSList, *GSList]{Name: "g_slist_last"}
	g_slist_length                  = cc.DlFunc[func(list *GSList) uint32, uint32]{Name: "g_slist_length"}
	g_slist_foreach                 = cc.DlFunc[func(list *GSList, fn UPtr, userData UPtr), cc.Void]{Name: "g_slist_foreach"}
	g_slist_sort                    = cc.DlFunc[func(list *GSList, compareFunc UPtr) *GSList, *GSList]{Name: "g_slist_sort"}
	g_slist_sort_with_data          = cc.DlFunc[func(list *GSList, compareDataFunc UPtr, userData UPtr) *GSList, *GSList]{Name: "g_slist_sort_with_data"}
	g_slist_nth_data                = cc.DlFunc[func(list *GSList, n uint32) UPtr, UPtr]{Name: "g_slist_nth_data"}
	g_clear_slist                   = cc.DlFunc[func(slistPtr **GSList, destroy UPtr), cc.Void]{Name: "g_clear_slist"}
	// #endregion

	// #region String
	g_string_new                = cc.DlFunc[func(string) *GString, *GString]{Name: "g_string_new"}
	g_string_new_len            = cc.DlFunc[func(string, int) *GString, *GString]{Name: "g_string_new_len"}
	g_string_new_take           = cc.DlFunc[func(UPtr) *GString, *GString]{Name: "g_string_new_take"}
	...
	g_string_assign             = cc.DlFunc[func(*GString, string) *GString, *GString]{Name: "g_string_assign"}
	...
	g_string_insert_len         = cc.DlFunc[func(*GString, int, string, int) *GString, *GString]{Name: "g_string_insert_len"}
	g_string_append             = cc.DlFunc[func(*GString, string) *GString, *GString]{Name: "g_string_append"}
	g_string_append_len         = cc.DlFunc[func(*GString, string, int) *GString, *GString]{Name: "g_string_append_len"}
	...
	g_string_prepend            = cc.DlFunc[func(*GString, string) *GString, *GString]{Name: "g_string_prepend"}
	...
	g_string_prepend_len        = cc.DlFunc[func(*GString, string, int) *GString, *GString]{Name: "g_string_prepend_len"}
	g_string_insert             = cc.DlFunc[func(*GString, int, string) *GString, *GString]{Name: "g_string_insert"}
	...
	g_string_overwrite          = cc.DlFunc[func(*GString, uint, string) *GString, *GString]{Name: "g_string_overwrite"}
	g_string_overwrite_len      = cc.DlFunc[func(*GString, uint, string, int) *GString, *GString]{Name: "g_string_overwrite_len"}
	g_string_erase              = cc.DlFunc[func(*GString, int, int) *GString, *GString]{Name: "g_string_erase"}
	g_string_replace            = cc.DlFunc[func(*GString, string, string, uint32) uint32, uint32]{Name: "g_string_replace"}
	...
	g_string_printf             = cc.DlFunc[func(p *GString, f string), cc.Void]{Name: "g_string_printf"}
	g_string_append_printf      = cc.DlFunc[func(p *GString, f string), cc.Void]{Name: "g_string_append_printf"}
	g_string_append_uri_escaped = cc.DlFunc[func(*GString, string, string, bool) *GString, *GString]{Name: "g_string_append_uri_escaped"}
	...
	// #region Variant
	g_variant_type_new            = cc.DlFunc[func(string) *GVariantType, *GVariantType]{Name: "g_variant_type_new"}
	...
	g_variant_type_dup_string        = cc.DlFunc[func(*GVariantType) string, string]{Name: "g_variant_type_dup_string"}
	g_variant_type_element           = cc.DlFunc[func(*GVariantType) *GVariantType, *GVariantType]{Name: "g_variant_type_element"}
	g_variant_type_equal             = cc.DlFunc[func(*GVariantType, *GVariantType) bool, bool]{Name: "g_variant_type_equal"}
	...
	g_variant_type_is_array          = cc.DlFunc[func(*GVariantType) bool, bool]{Name: "g_variant_type_is_array"}
	g_variant_type_is_basic          = cc.DlFunc[func(*GVariantType) bool, bool]{Name: "g_variant_type_is_basic"}
	g_variant_type_is_container      = cc.DlFunc[func(*GVariantType) bool, bool]{Name: "g_variant_type_is_container"}
	g_variant_type_is_definite       = cc.DlFunc[func(*GVariantType) bool, bool]{Name: "g_variant_type_is_definite"}
	g_variant_type_is_dict_entry     = cc.DlFunc[func(*GVariantType) bool, bool]{Name: "g_variant_type_is_dict_entry"}
	g_variant_type_is_maybe          = cc.DlFunc[func(*GVariantType) bool, bool]{Name: "g_variant_type_is_maybe"}
	g_variant_type_is_subtype_of     = cc.DlFunc[func(*GVariantType, *GVariantType) bool, bool]{Name: "g_variant_type_is_subtype_of"}
	g_variant_type_is_tuple          = cc.DlFunc[func(*GVariantType) bool, bool]{Name: "g_variant_type_is_tuple"}
	g_variant_type_is_variant        = cc.DlFunc[func(*GVariantType) bool, bool]{Name: "g_variant_type_is_variant"}
	...
	g_variant_type_peek_string       = cc.DlFunc[func(*GVariantType) string, string]{Name: "g_variant_type_peek_string"}
	g_variant_type_value             = cc.DlFunc[func(*GVariantType) *GVariantType, *GVariantType]{Name: "g_variant_type_value"}

	g_variant_new                  = cc.DlFunc[func(string) *GVariant, *GVariant]{Name: "g_variant_new"}
	g_variant_new_array            = cc.DlFunc[func(*GVariantType, **GVariant, int64) *GVariant, *GVariant]{Name: "g_variant_new_array"}
	g_variant_new_boolean          = cc.DlFunc[func(bool) *GVariant, *GVariant]{Name: "g_variant_new_boolean"}
	g_variant_new_byte             = cc.DlFunc[func(byte) *GVariant, *GVariant]{Name: "g_variant_new_byte"}
	g_variant_new_bytestring       = cc.DlFunc[func(string) *GVariant, *GVariant]{Name: "g_variant_new_bytestring"}
	...
	g_variant_new_fixed_array      = cc.DlFunc[func(*GVariantType, UPtr, uint, uint) *GVariant, *GVariant]{Name: "g_variant_new_fixed_array"}
	g_variant_new_from_bytes       = cc.DlFunc[func(*GVariantType, *GBytes, bool) *GVariant, *GVariant]{Name: "g_variant_new_from_bytes"}
	...
	g_variant_new_object_path = cc.DlFunc[func(string) *GVariant, *GVariant]{Name: "g_variant_new_object_path"}
	g_variant_new_objv        = cc.DlFunc[func(cc.Strings, int64) *GVariant, *GVariant]{Name: "g_variant_new_objv"}
	g_variant_new_parsed      = cc.DlFunc[func(string) *GVariant, *GVariant]{Name: "g_variant_new_parsed"}
	// g_variant_new_parsed_va       func(string, va_list) *GVariant
	g_variant_new_printf    = cc.DlFunc[func(string) *GVariant, *GVariant]{Name: "g_variant_new_printf"}
	g_variant_new_signature = cc.DlFunc[func(string) *GVariant, *GVariant]{Name: "g_variant_new_signature"}
	g_variant_new_string    = cc.DlFunc[func(string) *GVariant, *GVariant]{Name: "g_variant_new_string"}
	...
	g_variant_new_tuple   = cc.DlFunc[func(**GVariant, uint) *GVariant, *GVariant]{Name: "g_variant_new_tuple"}
	...
	g_variant_check_format_string  = cc.DlFunc[func(*GVariant, string, bool) bool, bool]{Name: "g_variant_check_format_string"}
	...
	g_variant_equal                = cc.DlFunc[func(*GVariant, *GVariant) bool, bool]{Name: "g_variant_equal"}
	g_variant_get                  = cc.DlFunc[func(*GVariant, string, UPtr), cc.Void]{Name: "g_variant_get"}
	g_variant_get_boolean          = cc.DlFunc[func(*GVariant) bool, bool]{Name: "g_variant_get_boolean"}
	...
	g_variant_get_child            = cc.DlFunc[func(*GVariant, uint, string, UPtr), cc.Void]{Name: "g_variant_get_child"}
	g_variant_get_child_value      = cc.DlFunc[func(*GVariant, uint) *GVariant, *GVariant]{Name: "g_variant_get_child_value"}
	...
	g_variant_get_fixed_array      = cc.DlFunc[func(*GVariant, *uint, uint) UPtr, UPtr]{Name: "g_variant_get_fixed_array"}
	...
	g_variant_get_type_string      = cc.DlFunc[func(*GVariant) string, string]{Name: "g_variant_get_type_string"}
	...
	g_variant_hash                 = cc.DlFunc[func(*GVariant) uint, uint]{Name: "g_variant_hash"}
	g_variant_is_container         = cc.DlFunc[func(*GVariant) bool, bool]{Name: "g_variant_is_container"}
	g_variant_is_floating          = cc.DlFunc[func(*GVariant) bool, bool]{Name: "g_variant_is_floating"}
	g_variant_is_normal_form       = cc.DlFunc[func(*GVariant) bool, bool]{Name: "g_variant_is_normal_form"}
	g_variant_is_of_type           = cc.DlFunc[func(*GVariant, *GVariantType) bool, bool]{Name: "g_variant_is_of_type"}
	g_variant_iter_new             = cc.DlFunc[func(*GVariant) *GVariantIter, *GVariantIter]{Name: "g_variant_iter_new"}
	g_variant_lookup               = cc.DlFunc[func(*GVariant, string, string, ...interface{}) bool, bool]{Name: "g_variant_lookup", Va: true}
	g_variant_lookup_value         = cc.DlFunc[func(*GVariant, string, *GVariantType) *GVariant, *GVariant]{Name: "g_variant_lookup_value"}
	g_variant_n_children           = cc.DlFunc[func(*GVariant) uint, uint]{Name: "g_variant_n_children"}
	g_variant_print                = cc.DlFunc[func(*GVariant, bool) string, string]{Name: "g_variant_print"}
	g_variant_print_string         = cc.DlFunc[func(*GVariant, *GString, bool) *GString, *GString]{Name: "g_variant_print_string"}
	...
	g_getenv = cc.DlFunc[func(string) string, string]{Name: "g_getenv"}
	g_setenv = cc.DlFunc[func(string, string, bool) bool, bool]{Name: "g_setenv"}
