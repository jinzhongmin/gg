...
var (
	...
	// #region Array
	g_array_new                      = cc.DlFunc[func(zeroTerminated, clear int32, elementSize uint32) uptr, uptr]{Name: "g_array_new"}
	g_array_new_take                 = cc.DlFunc[func(data uptr, length uint64, clear int32, elementSize uint64) uptr, uptr]{Name: "g_array_new_take"}
	g_array_new_take_zero_terminated = cc.DlFunc[func(data uptr, clear int32, elementSize uint64) uptr, uptr]{Name: "g_array_new_take_zero_terminated"}
	g_array_steal                    = cc.DlFunc[func(array uptr, length *uint64) uptr, uptr]{Name: "g_array_steal"}
	g_array_sized_new                = cc.DlFunc[func(zeroTerminated, clear int32, elementSize, reservedSize uint32) uptr, uptr]{Name: "g_array_sized_new"}
	g_array_copy                     = cc.DlFunc[func(array uptr) uptr, uptr]{Name: "g_array_copy"}
	g_array_free                     = cc.DlFunc[func(array uptr, freeSegment int32) uptr, uptr]{Name: "g_array_free"}
	...
	g_array_binary_search            = cc.DlFunc[func(array uptr, target uptr, compareFunc uptr, outMatchIndex *uint32) int32, int32]{Name: "g_array_binary_search"}
	...
	g_ptr_array_new_null_terminated            = cc.DlFunc[func(reservedSize uint32, elementFreeFunc cc.Func, nullTerminated int32) uptr, uptr]{Name: "g_ptr_array_new_null_terminated"}
	...
	g_ptr_array_free                           = cc.DlFunc[func(array uptr, freeSegment int32) uptr, uptr]{Name: "g_ptr_array_free"}
	...
	g_ptr_array_remove                         = cc.DlFunc[func(array uptr, data uptr) int32, int32]{Name: "g_ptr_array_remove"}
	g_ptr_array_remove_fast                    = cc.DlFunc[func(array uptr, data uptr) int32, int32]{Name: "g_ptr_array_remove_fast"}
	...
	g_ptr_array_find                           = cc.DlFunc[func(haystack uptr, needle uptr, index *uint32) int32, int32]{Name: "g_ptr_array_find"}
	g_ptr_array_find_with_equal_func           = cc.DlFunc[func(haystack uptr, needle uptr, equalFunc uptr, index *uint32) int32, int32]{Name: "g_ptr_array_find_with_equal_func"}
	g_ptr_array_is_null_terminated             = cc.DlFunc[func(array uptr) int32, int32]{Name: "g_ptr_array_is_null_terminated"}
	...
	g_byte_array_free              = cc.DlFunc[func(array *GByteArray, freeSegment int32) *byte, *byte]{Name: "g_byte_array_free"}
	...
	g_async_queue_remove               = cc.DlFunc[func(q *GAsyncQueue, item uptr) int32, int32]{Name: "g_async_queue_remove"}
	g_async_queue_remove_unlocked      = cc.DlFunc[func(q *GAsyncQueue, item uptr) int32, int32]{Name: "g_async_queue_remove_unlocked"}
	...
	g_bytes_equal          = cc.DlFunc[func(*GBytes, *GBytes) int32, int32]{Name: "g_bytes_equal"}
	...
	g_date_time_new_from_unix_local_usec  = cc.DlFunc[func(int64) *GDateTime, *GDateTime]{Name: "g_date_time_new_from_unix_local_usec"}
	g_date_time_new_from_unix_utc_usec    = cc.DlFunc[func(int64) *GDateTime, *GDateTime]{Name: "g_date_time_new_from_unix_utc_usec"}
	g_date_time_new_from_iso8601          = cc.DlFunc[func(cc.String, *GTimeZone) *GDateTime, *GDateTime]{Name: "g_date_time_new_from_iso8601"}
	...
	g_date_time_compare                   = cc.DlFunc[func(*GDateTime, *GDateTime) int, int]{Name: "g_date_time_compare"}
	g_date_time_difference                = cc.DlFunc[func(*GDateTime, *GDateTime) GTimeSpan, GTimeSpan]{Name: "g_date_time_difference"}
	g_date_time_hash                      = cc.DlFunc[func(*GDateTime) uint32, uint32]{Name: "g_date_time_hash"}
	g_date_time_equal                     = cc.DlFunc[func(*GDateTime, *GDateTime) int32, int32]{Name: "g_date_time_equal"}
	...
	g_date_time_to_unix_usec              = cc.DlFunc[func(*GDateTime) int64, int64]{Name: "g_date_time_to_unix_usec"}
	g_date_time_get_utc_offset            = cc.DlFunc[func(*GDateTime) GTimeSpan, GTimeSpan]{Name: "g_date_time_get_utc_offset"}
	g_date_time_get_timezone              = cc.DlFunc[func(*GDateTime) *GTimeZone, *GTimeZone]{Name: "g_date_time_get_timezone"}
	...
	g_date_time_is_daylight_savings       = cc.DlFunc[func(*GDateTime) int32, int32]{Name: "g_date_time_is_daylight_savings"}
	...
	g_date_time_format_iso8601            = cc.DlFunc[func(*GDateTime) cc.String, cc.String]{Name: "g_date_time_format_iso8601"}
	// #endregion
	...
	g_error_matches                = cc.DlFunc[func(*GError, GQuark, int32) int32, int32]{Name: "g_error_matches"}
	// #endregion
	...
	g_main_context_iteration                      = cc.DlFunc[func(context *GMainContext, mayBlock int32) int32, int32]{Name: "g_main_context_iteration"}
	g_main_context_pending                        = cc.DlFunc[func(context *GMainContext) int32, int32]{Name: "g_main_context_pending"}
	...
	g_main_context_acquire                        = cc.DlFunc[func(context *GMainContext) int32, int32]{Name: "g_main_context_acquire"}
	g_main_context_release                        = cc.DlFunc[func(context *GMainContext), cc.Void]{Name: "g_main_context_release"}
	g_main_context_is_owner                       = cc.DlFunc[func(context *GMainContext) int32, int32]{Name: "g_main_context_is_owner"}
	g_main_context_wait                           = cc.DlFunc[func(context *GMainContext, cond uptr, mutex uptr) int32, int32]{Name: "g_main_context_wait"}
	g_main_context_prepare                        = cc.DlFunc[func(context *GMainContext, priority *int32) int32, int32]{Name: "g_main_context_prepare"}
	...
	g_main_context_check                          = cc.DlFunc[func(context *GMainContext, maxPriority int32, fds *GPollFD, nFds int32) int32, int32]{Name: "g_main_context_check"}
	...
	g_main_loop_new                               = cc.DlFunc[func(context *GMainContext, isRunning int32) *GMainLoop, *GMainLoop]{Name: "g_main_loop_new"}
	...
	g_main_loop_is_running                        = cc.DlFunc[func(loop *GMainLoop) int32, int32]{Name: "g_main_loop_is_running"}
	...
	g_source_set_can_recurse                      = cc.DlFunc[func(source *GSource, canRecurse int32), cc.Void]{Name: "g_source_set_can_recurse"}
	g_source_get_can_recurse                      = cc.DlFunc[func(source *GSource) int32, int32]{Name: "g_source_get_can_recurse"}
	...
	g_source_is_destroyed                         = cc.DlFunc[func(source *GSource) int32, int32]{Name: "g_source_is_destroyed"}
	...
	g_source_remove                    = cc.DlFunc[func(tag uint32) int32, int32]{Name: "g_source_remove"}
	g_source_remove_by_user_data       = cc.DlFunc[func(userData uptr) int32, int32]{Name: "g_source_remove_by_user_data"}
	g_source_remove_by_funcs_user_data = cc.DlFunc[func(funcs *GSourceFuncs, userData uptr) int32, int32]{Name: "g_source_remove_by_funcs_user_data"}
	...
	g_idle_remove_by_data              = cc.DlFunc[func(data uptr) int32, int32]{Name: "g_idle_remove_by_data"}
	// #endregion
	...
	g_option_context_set_strict_posix           = cc.DlFunc[func(*GOptionContext, int32), cc.Void]{Name: "g_option_context_set_strict_posix"}
	...
	g_string_free               = cc.DlFunc[func(*GString, int32) uptr, uptr]{Name: "g_string_free"}
	...
	g_string_equal              = cc.DlFunc[func(*GString, *GString) int32, int32]{Name: "g_string_equal"}
	...
	g_string_append_uri_escaped = cc.DlFunc[func(*GString, cc.String, cc.String, int32) *GString, *GString]{Name: "g_string_append_uri_escaped"}
	...
	g_time_zone_new_identifier   = cc.DlFunc[func(cc.String) *GTimeZone, *GTimeZone]{Name: "g_time_zone_new_identifier"}
	...
	g_time_zone_new_offset       = cc.DlFunc[func(int32) *GTimeZone, *GTimeZone]{Name: "g_time_zone_new_offset"}
	...
	g_time_zone_is_dst           = cc.DlFunc[func(*GTimeZone, int) int32, int32]{Name: "g_time_zone_is_dst"}
	g_time_zone_get_identifier   = cc.DlFunc[func(*GTimeZone) cc.String, cc.String]{Name: "g_time_zone_get_identifier"}
	// #endregion
	...
	g_variant_get_bytestring       = cc.DlFunc[func(*GVariant) cc.String, cc.String]{Name: "g_variant_get_bytestring"}
	...
	// g_variant_get_va               = cc.DlFunc[func(*GVariant, cc.String, *cc.String, *[]interface{}), cc.Void]{Name: "g_variant_get_va"}
